...
public class ReminderService {
    ...
    @Autowired
    public ReminderService(EmailService emailService, UserService userService, NoteRepository noteRepository){
    ...
    public void emailReminder() throws MessagingException {
